...
<svelte:head>
	<title>Masuk — Smart Doc Reader</title>
</svelte:head>
...
<main class="max-w-[400px] mx-auto mt-24 px-4 pb-20">
	<div class="mb-8 text-center">
		<h1 class="text-3xl font-display font-medium text-brand mb-2">Masuk</h1>
		<p class="text-brand/60">Selamat datang kembali ke Smart Doc Reader.</p>
	</div>
	...
	<div class="bg-white p-8 rounded-[22px] border border-brand/10 shadow-sm relative overflow-hidden">
		...
		<div class="mt-6 text-center text-sm text-brand/60 relative z-10">
			Belum punya akun? <a href="/register" class="text-brand font-medium hover:underline">Daftar</a>
		</div>
	</div>
</main>
